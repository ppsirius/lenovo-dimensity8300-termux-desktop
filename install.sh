...
echo -e "${G}╚══════════════════════════════════════════════════════════╝${N}\n"
echo -e "${W}Start the desktop (this session only — or open a new Termux tab):${N}"
echo -e "   ${C}~/bin/desktop${N}              ${GR}# pick from installed${N}"
echo -e "   ${C}~/bin/desktop xfce4${N}        ${GR}# launch directly${N}"
echo -e "   ${C}~/bin/desktop i3${N}           ${GR}# launch i3${N}"
echo -e "\n${GR}New Termux tabs will have \`desktop\` on PATH automatically.${N}"
echo -e "${GR}Tip: run 'desktop-help' for the upstream command cheat-sheet.${N}"
